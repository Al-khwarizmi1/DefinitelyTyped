...
interface Casper extends EventEmitter {
	...
	waitForResource(test: Function, then?: Function, onTimeout?: Function, timeout?: number): Casper;
	waitForResource(testFx: RegExp, then?: Function, onTimeout?: Function, timeout?: number): Casper;
